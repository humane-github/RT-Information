...
/*!
 * @class JuliusClientComp
 * @brief Standalone component Class
 *
 */
public class JuliusClientComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(JuliusClient.component_conf);
      mgr.registerFactory(prop, new JuliusClient(), new JuliusClient());

      // Create a component
      RTObject_impl comp = mgr.createComponent("JuliusClient");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        JuliusClientComp init = new JuliusClientComp();
