...
# Import target "wstr2str" for configuration "Release"
SET_PROPERTY(TARGET wstr2str APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
SET_TARGET_PROPERTIES(wstr2str PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/components/lib/wstr2str.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/components/bin/wstr2str.dll"
  )
...
# Import target "wstr2strComp" for configuration "Release"
SET_PROPERTY(TARGET wstr2strComp APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
SET_TARGET_PROPERTIES(wstr2strComp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/components/bin/wstr2strComp.exe"
  )
