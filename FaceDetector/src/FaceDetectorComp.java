...
/*!
 * @class FaceDetectorComp
 * @brief Standalone component Class
 *
 */
public class FaceDetectorComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(FaceDetector.component_conf);
      mgr.registerFactory(prop, new FaceDetector(), new FaceDetector());

      // Create a component
      RTObject_impl comp = mgr.createComponent("FaceDetector");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        FaceDetectorComp init = new FaceDetectorComp();
