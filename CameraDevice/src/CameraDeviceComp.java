...
/*!
 * @class CameraDeviceComp
 * @brief Standalone component Class
 *
 */
public class CameraDeviceComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(CameraDevice.component_conf);
      mgr.registerFactory(prop, new CameraDevice(), new CameraDevice());

      // Create a component
      RTObject_impl comp = mgr.createComponent("CameraDevice");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        CameraDeviceComp init = new CameraDeviceComp();
