 ...
 *
 */
public class str2wstrComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(str2wstr.component_conf);
      mgr.registerFactory(prop, new str2wstr(), new str2wstr());

      // Create a component
      RTObject_impl comp = mgr.createComponent("str2wstr");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        str2wstrComp init = new str2wstrComp();
