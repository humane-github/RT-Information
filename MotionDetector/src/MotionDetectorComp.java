...
/*!
 * @class MotionDetectorComp
 * @brief Standalone component Class
 *
 */
public class MotionDetectorComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(MotionDetector.component_conf);
      mgr.registerFactory(prop, new MotionDetector(), new MotionDetector());

      // Create a component
      RTObject_impl comp = mgr.createComponent("MotionDetector");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        MotionDetectorComp init = new MotionDetectorComp();
