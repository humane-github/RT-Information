// -*- Java -*-
/*!
 * @file InfoClerkManagerComp.java
...
/*!
 * @class InfoClerkManagerComp
 * @brief Standalone component Class
 *
 */
public class InfoClerkManagerComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(InfoClerkManager.component_conf);
      mgr.registerFactory(prop, new InfoClerkManager(), new InfoClerkManager());

      // Create a component
      RTObject_impl comp = mgr.createComponent("InfoClerkManager");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        InfoClerkManagerComp init = new InfoClerkManagerComp();
